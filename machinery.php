...
<body>
    ...
    <section class="header">
        <div class="nav-bar">
            <div class="left-side">
                <div class="logo">
                <h2 class="logo"><i class='bx bxl-xing'></i>Sheti Vidnyan</h2>
                </div>
            </div>
    ...
    <section class="footer">
        <div class="left-side-footer">
            <p>&copy;2024 All Rights Reserved.AgZone.</p>
        </div>
        <div class="right-side-footer">
            <p>Web Design and Development by<a href="index.html">ShetiVidnyan Team</a></p>
        </div>
    </section>
